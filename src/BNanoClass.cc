...
void BNanoClass::Init(TTree *tree)
{
	...
	std::cout << "Before set branch address " << std::endl;
	...
	std::cout << "doing set branch address " << std::endl;
	...
	std::cout << "after set branch address " << std::endl;
}
...
*/
	...
	std::cout << "in isMcB " << RK_res2 << " " <<  RK_res1 << " "  <<std::endl;
